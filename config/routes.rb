...
#                       search_detail_listings GET        (/:locale)/listings/search_detail(.:format)                                                     listings#search_detail {:locale=>/en/}
...
#      listing_reservation_review_review_reply POST       (/:locale)/listings/:listing_id/reservations/:reservation_id/review/review_reply(.:format)      review_replies#create {:locale=>/en/}
#  new_listing_reservation_review_review_reply GET        (/:locale)/listings/:listing_id/reservations/:reservation_id/review/review_reply/new(.:format)  review_replies#new {:locale=>/en/}
# edit_listing_reservation_review_review_reply GET        (/:locale)/listings/:listing_id/reservations/:reservation_id/review/review_reply/edit(.:format) review_replies#edit {:locale=>/en/}
#                                              GET        (/:locale)/listings/:listing_id/reservations/:reservation_id/review/review_reply(.:format)      review_replies#show {:locale=>/en/}
#                                              PATCH      (/:locale)/listings/:listing_id/reservations/:reservation_id/review/review_reply(.:format)      review_replies#update {:locale=>/en/}
#                                              PUT        (/:locale)/listings/:listing_id/reservations/:reservation_id/review/review_reply(.:format)      review_replies#update {:locale=>/en/}
#                                              DELETE     (/:locale)/listings/:listing_id/reservations/:reservation_id/review/review_reply(.:format)      review_replies#destroy {:locale=>/en/}
#                   listing_reservation_review POST       (/:locale)/listings/:listing_id/reservations/:reservation_id/review(.:format)                   reviews#create {:locale=>/en/}
#               new_listing_reservation_review GET        (/:locale)/listings/:listing_id/reservations/:reservation_id/review/new(.:format)               reviews#new {:locale=>/en/}
#              edit_listing_reservation_review GET        (/:locale)/listings/:listing_id/reservations/:reservation_id/review/edit(.:format)              reviews#edit {:locale=>/en/}
#                                              GET        (/:locale)/listings/:listing_id/reservations/:reservation_id/review(.:format)                   reviews#show {:locale=>/en/}
#                                              PATCH      (/:locale)/listings/:listing_id/reservations/:reservation_id/review(.:format)                   reviews#update {:locale=>/en/}
#                                              PUT        (/:locale)/listings/:listing_id/reservations/:reservation_id/review(.:format)                   reviews#update {:locale=>/en/}
#                                              DELETE     (/:locale)/listings/:listing_id/reservations/:reservation_id/review(.:format)                   reviews#destroy {:locale=>/en/}
#                         listing_reservations POST       (/:locale)/listings/:listing_id/reservations(.:format)                                          reservations#create {:locale=>/en/}
#                          listing_reservation GET        (/:locale)/listings/:listing_id/reservations/:id(.:format)                                      reservations#show {:locale=>/en/}
#                                              PATCH      (/:locale)/listings/:listing_id/reservations/:id(.:format)                                      reservations#update {:locale=>/en/}
#                                              PUT        (/:locale)/listings/:listing_id/reservations/:id(.:format)                                      reservations#update {:locale=>/en/}
#            edit_listing_reservations_setting GET        (/:locale)/listings/:listing_id/reservations/setting/edit(.:format)                             settings#edit {:locale=>/en/}
#                 listing_reservations_setting PATCH      (/:locale)/listings/:listing_id/reservations/setting(.:format)                                  settings#update {:locale=>/en/}
#                                              PUT        (/:locale)/listings/:listing_id/reservations/setting(.:format)                                  settings#update {:locale=>/en/}
