...
# end
  ...
  index do
    ...
    column I18n.t('activerecord.attributes.listing.description_en'), :description_en
    ...
    column I18n.t('activerecord.attributes.listing.visit_benefits_en'), :visit_benefits_en
    column I18n.t('activerecord.attributes.listing.visit_benefits_another'), :visit_benefits_another
    column I18n.t('activerecord.attributes.listing.visit_benefits_another_en'), :visit_benefits_another_en
  ...
  form do |f|
    f.inputs "店舗情報の詳細" do
      ...
      f.input :visit_benefits_en
      f.input :visit_benefits_another
      f.input :visit_benefits_another_en
  ...
  show do
    attributes_table do
      ...
      row I18n.t('activerecord.attributes.listing.description_en') do
      ...
      row I18n.t('activerecord.attributes.listing.visit_benefits_en') do
        resource.visit_benefits_en
      end
      row I18n.t('activerecord.attributes.listing.visit_benefits_another') do
        resource.visit_benefits_another
      end
      row I18n.t('activerecord.attributes.listing.visit_benefits_another_en') do
        resource.visit_benefits_another_en
      end
