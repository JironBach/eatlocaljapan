ActiveAdmin.register Listing do
  ...
  # end
  permit_params \
    :user_id, :open, :ave_total, :ave_accuracy, :ave_communication, :ave_cleanliness, :ave_location, :ave_check_in, :ave_cost_performance, :open,
    :zipcode, :location, :longitude, :latitude, :delivery_flg, :price, :description, :title, :title_en, :capacity, :direction, :cover_image_caption,
    ...
    :visit_benefits, :visit_benefits_another, :smoking_id, :price_low_dinner, :price_high_dinner, :english_message_ids, :info_admin_id, :link_tabelog,
